...
API_ID = int(getenv("API_ID", "20575736"))
API_HASH = getenv("API_HASH", " 015c0adf1b17ca32639d02afc6224072")
OWNER = int(os.getenv("OWNER", "1861702459"))
BOT_TOKEN = getenv("BOT_TOKEN","7809788070:AAHYBnrJlaTsD_hvoSL_93EG8ea8a-Qxv1g")
Muntazer = getenv("Muntazer", "wq_3q")
assistant = getenv("assistant", "dev_radio_vip")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002331701179"))
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "freedom")
PROTECT_CONTENT = getenv("PROTECT_CONTENT", "True")
OWNER_ID = list(map(int, getenv("OWNER_ID", "1861702459").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/copra1782/hamo")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN","")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/wq_3q")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/wq_3q") 
...
STRING1 = getenv("STRING_SESSION", "BAFHAJwADMuDE_MIquWT5CCgFHyQEOb36cqQVglJj3Y7vG6Z4iZpa-LB8ws2-fGr6uKsxiw3DBIWBV_awFTZ-YVKYKD0Nv7G3tLm9GeUkUn4LGRLupoe3KqYDBK-q9Hra0-tMj5jhpFFvhTO_HQMQIle1qoV54PgWQb_lpFgeKeHY8fSwMq7gVPdLNQUPy5Dj_vuyc4ukNFyJgdukXtWYM97j1eCBp5GBSVjBgmwGTtLTarLXFHjh2vDp6hl48iSbp8j7SeBJb7bk5fEyymt6k1HsvFmMBS_zds1wxayr_1nBltCf1IeLAIqZigIVS19O-qYUUXxpvNuPjcQGjOiE26BuxZjjwAAAAGd5I1-AA")
